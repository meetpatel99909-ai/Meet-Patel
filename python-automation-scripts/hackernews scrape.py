...
df = pd.read_excel (r'\\qaserver\D-Drive\QA_TEAM_Data\Amit Data\CIMCON's Data\Python Files\python-automation-scripts\Child Link from python file.xlsx')
df = pd.read_excel (r'\\qaserver\D-Drive\QA_TEAM_Data\Amit Data\Risk File\TEST\TeSt\Master.xlsm')
print (df)
